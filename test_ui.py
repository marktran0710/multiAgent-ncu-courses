...
class TestInternationalAdvisorUI(unittest.TestCase):
    ...
    def test_public_benchmark_page_compares_old_and_current_versions(self):
        ...
        self.assertIn("ragas_evaluation", html)
        self.assertIn("RAGAS Evaluation", visible_text)
        self.assertIn("Context Precision", visible_text)
        self.assertIn("Answer Relevancy", visible_text)
